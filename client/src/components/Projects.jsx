            ...
            <div className='flex flex-col items-center justify-center w-full p-5 bg-slate-800'>
                ...
                <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 px-4'>
                    {projects.map((project, index) => (
                        <div key={index} className='flex flex-col bg-blue-900 border items-center rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-transform duration-500 ease-in-out cursor-pointer transform hover:-translate-y-2'>
                            ...
                            <div className='p-6 w-full'>
                                ...
                                <div className='flex justify-center gap-4'>
                                    <a href={project.githubLink} target="_blank" rel="noopener noreferrer" className='px-4 py-2 bg-gray-800 text-white text-sm rounded hover:bg-gray-700 transition duration-300 ease-in-out'>Github</a>
