...
import bannerImage from "../../../assets/coding.json";
    ...
    <div className="parent min-h-[100vh] flex flex-col-reverse lg:flex-row items-center justify-between">
      ...
      >
        ...
        <div className="flex items-center translate-y-[-60%] sm:translate-y-[-0%]">
          <a
            href="https://drive.google.com/file/d/1DqTSf9WmxPtB1JoV5Q5sukAtK51Ad6u2/view?usp=drive_link"
            target="blank"
          >
          ...
          <Link to="/about" className="ml-4">
            <SecondaryBtn className="relative overflow-hidden bg-secondary text-white px-4 py-2 rounded-lg hover:shadow-[0_0_15px_5px] hover:shadow-secondary transition duration-300">
              <span>About Me</span>
              <span>
                <RiFolderInfoFill />
              </span>
      ...
      >
        ...
        {/* <img src={mypic} alt="Hanzala Shaikh" className="w-1/2 rounded-3xl" /> */}
      </motion.div>
    </div>
  );
};
